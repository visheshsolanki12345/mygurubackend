...
class Interpretation_6th(models.Model):
...
class Reports(models.Model):
    ...
    interpretatio = models.ForeignKey(Interpretation_6th,on_delete=CASCADE, max_length=500, null=True, blank=True, related_name="interpretatio")
...
class GeneralInformation_6th(models.Model):
