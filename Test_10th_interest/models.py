...
class Questions(models.Model):
    ...
    f = models.CharField(null=True, blank=True, max_length=200)
    g = models.CharField(null=True, blank=True, max_length=200)
    h = models.CharField(null=True, blank=True, max_length=200)
    i = models.CharField(null=True, blank=True, max_length=200)
    j = models.CharField(null=True, blank=True, max_length=200)
    k = models.CharField(null=True, blank=True, max_length=200)
    l = models.CharField(null=True, blank=True, max_length=200)
    m = models.CharField(null=True, blank=True, max_length=200)
    n = models.CharField(null=True, blank=True, max_length=200)
    o = models.CharField(null=True, blank=True, max_length=200)
    p = models.CharField(null=True, blank=True, max_length=200)
    q = models.CharField(null=True, blank=True, max_length=200)
    r = models.CharField(null=True, blank=True, max_length=200)
    s = models.CharField(null=True, blank=True, max_length=200)
    t = models.CharField(null=True, blank=True, max_length=200)
    def __str__(self):
        return str(self.industry)
    
class Interpretation_10th_int(models.Model):
...
class Reports_10th_int(models.Model):
    user = models.ForeignKey(User,on_delete=CASCADE, max_length=100, null=True, blank=True)
    interpretatio = models.ForeignKey(Interpretation_10th_int,on_delete=CASCADE, max_length=500, null=True, blank=True, related_name="interpretatio")
    ...
    ans6 = models.IntegerField(null=True, blank=True)
    ans7 = models.IntegerField(null=True, blank=True)
    ans8 = models.IntegerField(null=True, blank=True)
    ans9 = models.IntegerField(null=True, blank=True)
    ans10 = models.IntegerField(null=True, blank=True)
    ans11 = models.IntegerField(null=True, blank=True)
    ans12 = models.IntegerField(null=True, blank=True)
    ans13 = models.IntegerField(null=True, blank=True)
    ans14 = models.IntegerField(null=True, blank=True)
    ans15 = models.IntegerField(null=True, blank=True)
    ans16 = models.IntegerField(null=True, blank=True)
    ans17 = models.IntegerField(null=True, blank=True)
    ans18 = models.IntegerField(null=True, blank=True)
    ans19 = models.IntegerField(null=True, blank=True)
    ans20 = models.IntegerField(null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        ResultCount = self.ans1 + self.ans2 + self.ans3 + self.ans4 + self.ans5 + self.ans6 + self.ans7 + self.ans8 + self.ans9 + self.ans10 + self.ans11 + self.ans12 + self.ans13 + self.ans14 + self.ans15 + self.ans16 + self.ans17 + self.ans18 + self.ans19 + self.ans20
        
        self.totalCount = ResultCount / 2
        super(Reports_10th_int, self).save(*args, **kwargs)
...
class ShowGrade(models.Model):
    ...
    HigeScore = models.CharField( max_length=100, null=True, blank=True)
    grade = models.CharField(max_length=100, null=True, blank=True)
    def __str__(self):
        return str(self.score)

class GeneralInformation_10th_Int(models.Model):
