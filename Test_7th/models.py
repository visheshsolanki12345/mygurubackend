...
class Interpretation_7th(models.Model):
...
class Reports_7th(models.Model):
    user = models.ForeignKey(User,on_delete=CASCADE, max_length=100, null=True, blank=True)
    interpretatio = models.ForeignKey(Interpretation_7th,on_delete=CASCADE, max_length=500, null=True, blank=True, related_name="interpretatio")
    ...
    def save(self, *args, **kwargs):
        ...
        super(Reports_7th, self).save(*args, **kwargs)
...
class GeneralInformation_7th(models.Model):
