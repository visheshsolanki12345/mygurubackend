...
from .models import  DefinedGrate, DefineClasses, IndustryCategory, Questions, Reports_7th, Test, ShowGrade, Interpretation_7th, GeneralInformation_7th
...
@admin.register(Interpretation_7th)
...
@admin.register(GeneralInformation_7th)
