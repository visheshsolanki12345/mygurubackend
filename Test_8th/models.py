...
class Questions(models.Model):
    ...
    question= models.ImageField(upload_to = '8th', null=True, blank=True, max_length=200)
    a = models.ImageField(upload_to = '8th', null=True, blank=True, max_length=200)
    b = models.ImageField(upload_to = '8th', null=True, blank=True, max_length=200)
    c = models.ImageField(upload_to = '8th', null=True, blank=True, max_length=200)
    d = models.ImageField(upload_to = '8th', null=True, blank=True, max_length=200)
...
class Interpretation_8th(models.Model):
...
class Reports_8th(models.Model):
    user = models.ForeignKey(User,on_delete=CASCADE, max_length=100, null=True, blank=True)
    interpretatio = models.ForeignKey(Interpretation_8th,on_delete=CASCADE, max_length=500, null=True, blank=True, related_name="interpretatio")
    ...
    def save(self, *args, **kwargs):
        ResultCount = self.ans1 + self.ans2 + self.ans3 + self.ans4
        self.totalCount = ResultCount
        super(Reports_8th, self).save(*args, **kwargs)
...
class GeneralInformation_8th(models.Model):
