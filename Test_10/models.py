...
class Interpretation_10th(models.Model):
...
class Reports_10th(models.Model):
    user = models.ForeignKey(User,on_delete=CASCADE, max_length=100, null=True, blank=True)
    interpretatio = models.ForeignKey(Interpretation_10th,on_delete=CASCADE, max_length=500, null=True, blank=True, related_name="interpretatio")
    ...
    def save(self, *args, **kwargs):
        ...
        super(Reports_10th, self).save(*args, **kwargs)
...
class GeneralInformation_10th(models.Model):
